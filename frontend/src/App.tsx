            ...
            element={
              <>
                <header>
                  <h1>DevMatch</h1>
                  <p>
                    Find your perfect dev partner. Team up, collaborate, and
                    build together.
                  </p>
                  <div className="cta">
                ...
                <section className="features">
                  <div className="feature">
                    ...
                    <p>
                      Filter by languages, frameworks, experience, or goals.
                    </p>
                  </div>
                  <div className="feature">
                  ...
                  <div className="feature">
                    <h2>💬 Instant Chat</h2>
                    <p>
                      Built-in real-time chat for fast collaboration and
                      bonding.
                    </p>
                  </div>
                  <div className="feature">
                    ...
                    <p>
                      Connect with developers from around the world, anytime.
                    </p>
                  </div>
                </section>
